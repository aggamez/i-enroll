...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-maroon sticky-top px-4">
            ...
            <div class="wrapper">
                <div class="bg h-100 vw-100 text-white" style="background-image: url('assets/img/bg2.png');">
                    <div class="h-100 w-100 d-flex flex-column justify-content-center align-items-center">
                        <div class="w-auto my-auto my-lg-0 p-3 p-lg-5 d-flex flex-column justify-content-center align-items-center bg-white rounded rounded-5">
